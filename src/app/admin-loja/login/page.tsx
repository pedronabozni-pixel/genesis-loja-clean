  ...
  return (
    <div className="min-h-screen bg-zinc-950 px-4 py-8 text-zinc-100">
      <div className="mx-auto max-w-md rounded-2xl border border-zinc-800 bg-zinc-900/70 p-6">
        ...
        <p className="mb-6 text-sm text-zinc-300">Acesso protegido por senha para gerenciar produtos, conteúdo e leads.</p>
        <StoreAdminLoginForm nextPath="/admin-loja/produtos" />
      </div>
    </div>
  );
}
